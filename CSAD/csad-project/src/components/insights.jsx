...
const Insights = () => {
  ...
  const muscleExercises = {
    ...
    deltoids: ["Overhead Press", "Lateral Raises", "Arnold Press"],
    trapezius: ["Shrugs", "Face Pulls", "Deadlifts"],
    lats: ["Pull-Ups", "Lat Pulldown", "Bent-Over Rows"],
    abs: ["Crunches", "Hanging Leg Raises", "Plank"],
    obliques: ["Russian Twists", "Side Plank", "Woodchoppers"],
    pectorals: ["Bench Press", "Push-Ups", "Chest Fly"],
    adductors: ["Sumo Squats", "Side Lunges", "Cable Adduction"],
    calves: ["Standing Calf Raises", "Seated Calf Raises", "Jump Rope"],
    hamstrings: ["Deadlifts", "Leg Curls", "Glute Bridges"],
    glutes: ["Squats", "Hip Thrusts", "Lunges"],
  ...
  return (
    ...
    <div>
      <main className="padding-none ">
        <div className="muscle-groups">
          <h1>Muscle Group Selector</h1>

          <h2>Arms</h2>
          <input type="checkbox" className="biceps muscles-helper" id="biceps" checked={selectedMuscles["biceps"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="biceps">Biceps</label>

          <input type="checkbox" className="deltoids muscles-helper" id="deltoids" checked={selectedMuscles["deltoids"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="deltoids">Deltoids</label>

          <input type="checkbox" className="forearms muscles-helper" id="forearms" checked={selectedMuscles["forearms"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="forearms">Forearms</label>

          <input type="checkbox" className="triceps muscles-helper" id="triceps" checked={selectedMuscles["triceps"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="triceps">Triceps</label>

          <h2>Back</h2>
          <input type="checkbox" className="trapezius muscles-helper" id="trapezius" checked={selectedMuscles["trapezius"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="trapezius">Trapezius</label>

          <input type="checkbox" className="lats muscles-helper" id="lats" checked={selectedMuscles["lats"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="lats">Lats</label>

          <h2>Core</h2>
          <input type="checkbox" className="abs muscles-helper" id="abs" checked={selectedMuscles["abs"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="abs">Abs</label>

          <input type="checkbox" className="obliques muscles-helper" id="obliques" checked={selectedMuscles["obliques"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="obliques">Obliques</label>

          <input type="checkbox" className="pectorals muscles-helper" id="pectorals" checked={selectedMuscles["pectorals"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="pectorals">Pectorals</label>

          <h2>Legs</h2>
          <input type="checkbox" className="adductors muscles-helper" id="adductors" checked={selectedMuscles["adductors"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="adductors">Adductors</label>

          <input type="checkbox" className="calves muscles-helper" id="calves" checked={selectedMuscles["calves"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="calves">Calves</label>

          <input type="checkbox" className="hamstrings muscles-helper" id="hamstrings" checked={selectedMuscles["hamstrings"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="hamstrings">Hamstrings</label>

          <input type="checkbox" className="glutes muscles-helper" id="glutes" checked={selectedMuscles["glutes"] || false} onChange={handleCheckboxChange} />
          <label htmlFor="glutes">Glutes</label>

          <input type="checkbox" className="quads muscles-helper" id="quads" checked={selectedMuscles["quads"] || false} onChange={handleCheckboxChange} />
      ...
      <g id="Trapezius">
        ...
        <h2>Recommended Exercises</h2>
          {recommendedExercises.length > 0 ? (
            ...
            <p>Select muscles to see recommended exercises.</p>
          )}
      </div>
        </div>
